package com.bala.todolistmanagement.rest.apidocs.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bala.todolistmanagement.rest.controller"))
                .paths(regex("/TodoListManagement/v2.0.0.*"))
                .build()
                .apiInfo(metaData());
     }
